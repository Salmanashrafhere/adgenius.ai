...
export default function CampaignsPage() {
  ...
  // Optimization: Memoize filtered campaigns to avoid O(N) filtering and string operations on every re-render.
  // We also normalize the searchQuery once outside the filter loop to improve performance for larger lists.
  // Expected impact: Reduces computation time for filtering, especially as the number of campaigns grows.
