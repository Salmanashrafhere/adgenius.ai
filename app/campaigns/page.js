...
export default function CampaignsPage() {
  ...
  // Performance optimization: Memoize filtered campaigns to avoid O(N*M) string
  // operations on every render. Normalizing searchQuery outside the loop
  // reduces redundant toLowerCase() calls.
