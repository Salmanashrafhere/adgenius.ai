...
export default function DashboardPage() {
  ...
  const [totalStats, setTotalStats] = useState({ totalCount: 0, totalAdsCount: 0 });
  ...
  const stats = useMemo(() => [
    { label: "Total Campaigns", value: totalStats.totalCount.toString(), icon: Megaphone, color: "text-indigo-600", bg: "bg-indigo-50" },
    { label: "Ads Generated", value: totalStats.totalAdsCount.toString(), icon: ImageIcon, color: "text-purple-600", bg: "bg-purple-50" },
