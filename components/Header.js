      ...
      <div className="flex flex-col gap-4 px-4 py-4 sm:flex-row sm:items-center sm:justify-between sm:px-6 lg:px-8">
        ...
        <div className="flex flex-1 flex-wrap items-center justify-end gap-3 sm:flex-nowrap">
          ...
          <div className="relative min-w-[180px] flex-1 sm:max-w-xs">
            ...
            />
            <div className="pointer-events-none absolute right-2 top-1/2 hidden -translate-y-1/2 items-center gap-0.5 rounded border border-slate-200 bg-slate-50 px-1.5 py-0.5 text-[10px] font-medium text-slate-400 sm:flex">
